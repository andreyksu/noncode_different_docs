...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Альтернативой настройке на XML является конфигурация на основе аннотаций
// Вместо того чтобы использовать XML для описания инструмента связывания бинов, разработчик переносит конфигурацию в сам класс компонента с помощью аннотаций для соответствующего объявления класса, метода или поля. 
// Как упоминалось в подразделе Пример: AutowiredAnnotationBeanPostProcessor, использование BeanPostProcessor в сочетании с аннотациями является распространенным средством расширения IoC-контейнера Spring. 
// Например, в Spring 2.0 появилась возможность принудительного использования требуемых свойств с помощью аннотации @Required.
// Spring 2.5 позволил использовать тот же общий подход для управления внедрением зависимостей с использованием Spring.
// По сути, аннотация @Autowired предоставляет те же возможности, которые описаны в разделе "Автоматическое обнаружение и связывание взаимодействующих объектов", но с более тонким контролем и более широкой применимостью. 
// В Spring 2.5 также добавлена поддержка аннотаций JSR-250, таких как @PostConstruct и @PreDestroy. Для Spring 3.0 была добавлена поддержка аннотаций JSR-330 (Внедрение зависимостей для Java), содержащихся в пакете javax.inject, таких как @Inject и @Named.

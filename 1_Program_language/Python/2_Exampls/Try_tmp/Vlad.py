test_case_1 = {
    "name": "Проверить клик на кнопку поиска",
    "steps": ["Открыть сайт", 'Найти кнопку с надписью "поиск"', "Кликнуть на кнопку"],
...
test_case_2 = {
    "name": "Проверить цвет кнопки поиска",
    "steps": [
        "Открыть сайт",
...
test_case_3 = {
    "name": "Проверить клик на кнопку входа",
    "steps": ["Открыть сайт", 'Найти кнопку с надписью "войти"', "Кликнуть на кнопку"],
...
class TestCase:
    ...
    # тест-кейс обычным
    @staticmethod
    def is_ordinary_case(target_test_case):
        return not target_test_case.get("is_automated")
...
class AutomatedTestCase:
    ...
    @staticmethod
    def is_automated_case(target_test_case):
        return target_test_case.get("is_automated")


test_report = {"automated": [], "ordinary": []}
...
def add_case_to_list(test_case):
    ...
    if AutomatedTestCase.is_automated_case(test_case):
        ...
        automated_case = AutomatedTestCase(
            test_case.get("name", ""),
            test_case.get("steps", []),
            test_case.get("e_result", ""),

class Rectangle:
    def __init__(self, aRec_1, aRec_2):
        self.set_corner(aRec_1, aRec_2)
        left_upper_corner = self.get_pos()
        right_bottom_corner = self.get_pos_1()
        self.set_corner(left_upper_corner, right_bottom_corner)
    ...
    def get_pos_1(self):
        right_bottom_x = round(max(self.rec_1[0], self.rec_2[0]), 2)
        right_bottom_y = round(min(self.rec_1[1], self.rec_2[1]), 2)
...
print(rect.get_pos(), rect.get_pos_1(), rect.getCenter(), rect.get_size(), sep=" ")
rect.scale(2.0)
print(rect.get_pos(), rect.get_pos_1(), rect.getCenter(), rect.get_size(), sep=" ")
rect.scale(2.0)
print(rect.get_pos(), rect.get_pos_1(), rect.getCenter(), rect.get_size(), sep=" ")

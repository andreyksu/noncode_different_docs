...
local magic_spells =
{
    ...
    swapped =
    {
        ...
        endianness = ENC_LITTLE_ENDIAN, --это стандартная последовательность для сети и для Intel - младшее значение будет записано в ячейке с большим номером. т.е. в 4байтовом int 1 будет храниться в ячейке с бо`льшим номером
    },
    modified =
    {
